...
/**
 * shadcn/ui Tabs, re-themed to Terminal Noir.
...
export function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex h-10 items-center justify-center bg-panel-2 p-1 text-fg-dim",
        className,
      )}
      {...props}
    />
